...
//print("The value of foo is \(foo)")
// it doesn't print because it doesn't know foo since it was defined in the bracket.
...
// it was able to print because the variable is not in the class.
...
greeting(greeting: nil, name: "Savir")
greeting(greeting: "How are you", name: "Gordon")
